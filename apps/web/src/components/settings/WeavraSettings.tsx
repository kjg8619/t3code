  ...
  return (
    <SettingsSection id="weavra-overview" title="Weavra · Read-only">
      <SettingsGroup divided={false} className="space-y-5 p-4">
        ...
        {snapshot && !run && (
          <p className="text-sm text-muted-foreground">No current Weavra Run for this checkout.</p>
        )}
          ...
          {graph ? (
            <>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs" aria-label="Weavra Runtime graph nodes">
